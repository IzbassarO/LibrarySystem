...
public class BorrowBookRepository implements BorrowBookRepositoryInter {
    ...
    public void changeBook(Book book) {
        ...
        try {
            ...
            st.setInt(1, book.getQuantityOfBook()-1);
    ...
    public void changeUser(User user) {
        ...
        try {
            ...
            st.setString(1, user.getBorrowedBooks());
    ...
    public void changeBook2(Book book) {
        Connection con = null;
        try {
            con = db.getConnection();
            String sql = "UPDATE books SET quantity = ? WHERE isbn = ?";
